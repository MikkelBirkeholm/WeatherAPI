export function translateWeathercode(code) {
    ...
    if (code === 0) {
        ...
        weather = {
            ...
            73: ['Sne', 'snowy.jpg', '🌨'],
            75: ['Kraftig sne', 'snowy-heavy.jpg', '❄️']
        }
        ...
        weather = ['Let til moderat tordenvejr', 'thunderstorm.jpg', '⛈️']
    } else if (code === 96 || code === 99) {
        weather = {
            96: ['Tordenvejr og hagl', 'thunderstorm.jpg', '⛈️'],
            99: ['Tordenvejr og krafitg hagl', 'thunderstorm.jpg', '⛈️']
        }
    }
